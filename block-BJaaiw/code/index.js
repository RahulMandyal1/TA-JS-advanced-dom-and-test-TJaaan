...
// function to make the ball moveable 
function moveball() {
  //  the ball started moving but it makes a line becuase we  not clearning previous made balls
  // so to clear the canvas everyTime
